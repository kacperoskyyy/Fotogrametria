...
void loop() {
  ...
  if(buttonStatus1 == 0){ startCycle(); buzzer(1); }      ////Button 1 wystaruje cykl  1 w buzzzerze - dluga melodia  0 w buzzerze krotka melodia
...
void photoCapture(){    
  Serial.println("takepic");    //Fraza służąca wywołaniu migawki aparatu telefonu poprzez specjalną aplikację
